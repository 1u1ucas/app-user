...
type LeaderBoardProps = {
 ...
 export default function LeaderBoard({ activity, setActivity }: LeaderBoardProps) {
    ...
    return (
        <div className="flex flex-col items-start justify-start gap-16 w-full sm:px-10 px-2">
